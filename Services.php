...
<section id="service">
    ...
    <div class="container">
        <div class="service-container">
            ...
            <a href="BP-Monitoring.html" class="service-link">
            ...
            <a href="ChronicDiseaseManagement.html" class="service-link">
                <div class="service-card">
            ...
            <a href="CustomerSupport.html" class="service-link">
                <div class="service-card">
            ...
            <a href="EmergencyServices.html" class="service-link">
                <div class="service-card">
            ...
            <a href="HomeDelivery.html" class="service-link">
                <div class="service-card">
                    <h3>Home Delivery</h3>
            ...
            <a href="LabBooking.html" class="service-link">
                <div class="service-card">
                    <h3>Lab Booking</h3>
                    <p>Our customer support team is available 24/7 to assist you with any questions or concerns.</p>
                </div>
            ...
            <a href="MedicineEqipmentRent.html" class="service-link">
                <div class="service-card">
            ...
            <a href="MedicalSynchronization.html" class="service-link">
                <div class="service-card">
                    <h3>Medical Synchronization</h3>
                    <p>Coordinating all your prescription refills so they can be picked up at the same time each month.</p>
                </div>
            </a>

            <a href="NutritionalCounselling.html" class="service-link">
                <div class="service-card">
                    <h3>Nutritional Counselling</h3>
                    <p>Sessions with a nutritionist to develop personalized diet plans and healthy eating strategies.</p>
                </div>
            </a>

            <a href="OnlineConsultation.html" class="service-link">
                <div class="service-card">
                    <h3>Online Consultation</h3>
                    <p>The online consultation with the doctor is available to assist you with any questions or concerns related to your cure.</p>
                </div>
            </a>
            <a href="OnlinePrescription.html" class="service-link">
                <div class="service-card">
            ...
            <a href="Telemedicine.html" class="service-link">
                <div class="service-card">
                    <h3>Telemedicine</h3>
                    <p>Virtual appointments with healthcare providers for medical advice, diagnoses, and treatment plans.</p>
                </div>
            </a>

            <a href="VaccineAdministration.html" class="service-link">
                <div class="service-card">
            ...
            <a href="WellnessProgram.html" class="service-link">
                <div class="service-card">
                    <h3>Wellness Programs</h3>
                    <p>Regular workshops on various health topics like nutrition, mental health, and chronic disease management.</p>
                </div>
            </a>                       
        </div>
    </div>
